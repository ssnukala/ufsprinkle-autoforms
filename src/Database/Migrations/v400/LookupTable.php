...
class LookupTable extends Migration {
    ...
    public function up() {
        if (!$this->schema->hasTable('sevak_lookup')) {
            ...
            $lookup_fields = [
                "5" => new Lookup(["category" => "frm_search_function", "value" => "between", "display_value" => "Range", "sort_order" => 0, "status" => "A"]),
                "6" => new Lookup(["category" => "frm_search_function", "value" => "like", "display_value" => "Like", "sort_order" => 0, "status" => "A"]),
                ...
                "7" => new Lookup(["category" => "frm_type", "value" => "checkbox", "display_value" => "Checkbox", "sort_order" => 0, "status" => "A"]),
                "8" => new Lookup(["category" => "frm_type", "value" => "date", "display_value" => "Date", "sort_order" => 0, "status" => "A"]),
                "9" => new Lookup(["category" => "frm_type", "value" => "password", "display_value" => "Password", "sort_order" => 0, "status" => "A"]),
                "10" => new Lookup(["category" => "frm_type", "value" => "radio", "display_value" => "RadioButton", "sort_order" => 0, "status" => "A"]),
                "11" => new Lookup(["category" => "frm_type", "value" => "select", "display_value" => "Select", "sort_order" => 0, "status" => "A"]),
                "12" => new Lookup(["category" => "frm_type", "value" => "statictext", "display_value" => "StaticText", "sort_order" => 0, "status" => "A"]),
                "13" => new Lookup(["category" => "frm_type", "value" => "text", "display_value" => "Text", "sort_order" => 0, "status" => "A"]),
                "14" => new Lookup(["category" => "frm_type", "value" => "textarea", "display_value" => "TextArea", "sort_order" => 0, "status" => "A"]),
                ...
                "15" => new Lookup(["category" => "rec_status", "value" => "A", "display_value" => "Active", "sort_order" => 0, "status" => "A"]),
